...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003173929836'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002916715370')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1003115990357'))

# hastags request features
request_channel = environ.get('REQUEST_CHANNEL', '-1003148730240')
